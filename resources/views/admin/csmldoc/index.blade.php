        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody id="document-list">
                ...
                <tr>
                    ...
                    <td>
                        {{-- Edit Button --}}
                        <a href="{{ route('admin.csmldoc.edit', $document->id) }}" class="btn btn-sm btn-primary">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    searchInput.addEventListener('keyup', function () {
        ...
        fetch(`/admin/csmldoc/search?query=${query}`)
                    ...
                    data.forEach(document => {
                        rows += `
                            <tr>
                                ...
                                <td>${document.expiry_date}</td>
                                <td>
                                    <a href="/admin/csmldoc/${document.id}/edit" class="btn btn-sm btn-primary">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <button class="btn btn-sm btn-danger delete-document" data-id="${document.id}">
                                        <i class="fas fa-trash"></i> Delete
    ...
    documentList.addEventListener('click', function (e) {
        if (e.target.classList.contains('delete-document')) {
            ...
            if (confirm('Are you sure you want to delete this document?')) {
                fetch(`/admin/csmldoc/${documentId}`, {
                    method: 'DELETE',
                    headers: {
